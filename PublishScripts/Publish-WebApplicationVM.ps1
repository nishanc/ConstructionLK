...
For more detailed documentation go to: https://go.microsoft.com/fwlink/?LinkID=394472 
...
function New-WebDeployPackage
{
    ...
    #To build your web application, use MsBuild.exe. For help, see MSBuild Command-Line Reference at: https://go.microsoft.com/fwlink/?LinkId=391339
}
...
function Test-WebApplication
{
    ...
    #Write a function to run unit tests on your web application, use VSTest.Console.exe. For help, see VSTest.Console Command-Line Reference at https://go.microsoft.com/fwlink/?LinkId=391340
}
...
try
{
    ...
    {
         throw 'Unable to load Azure PowerShell. To install the latest version, go to https://go.microsoft.com/fwlink/?LinkID=320552 .If you have already installed Azure PowerShell, you may need to restart your computer or manually import the module.'
    }
