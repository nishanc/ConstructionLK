...
namespace ConstructionLK.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        public ActionResult ConfirmEmailToContinue()
        {
            return View();
        }
        //
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Confirm your ConstructionLK account", ">>  " + callbackUrl);
        ...
        [AllowAnonymous]
        public ActionResult RegisterServiceProviderCooperate()
        {
            return View();
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterServiceProviderCooperate(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
        ...
        [AllowAnonymous]
        public ActionResult RegisterServiceProviderIndividual()
        {
            return View();
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterServiceProviderIndividual(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
