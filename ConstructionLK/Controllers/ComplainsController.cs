...
namespace ConstructionLK.Controllers
{
    public class ComplainsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ComplainedDate,ActionId,ComplainedBy,ComplainedAbout")] Complain complain)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ComplainedDate,ActionId,ComplainedBy,ComplainedAbout")] Complain complain)
        {
            if (ModelState.IsValid)
            {
